...
{
	public class FundTransaferByCustomerCommand
	{
		...
		public class Handler : RequestHandler<Command, Response>
		{
			...
			protected override Response Handle(Command request)
			{
				...
				try
				{
					...
					var isValidPin =   IdentityLogicHelper.VerifyPinHash(request.TransactionPin, sourceAccount.PINHash, sourceAccount.PINSalt);
